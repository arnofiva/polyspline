    ...
    var SplineLayerProxy = /** @class */ (function (_super) {
        ...
        function SplineLayerProxy() {
            ...
            _this.createSplineGraphic = function (graphic) {
                ...
                var splineGraphic = new Graphic({
                    attributes: graphic.attributes,
                    geometry: splineGeometry,
                });
                splineGraphic.attributes[LINE_OBJECT_ID_FIELD] = graphic.attributes[_this.lineLayer.objectIdField];
            ...
            _this.refreshSplines = function () {
                ...
                return _this.lineLayer.queryFeatures()
                    ...
                    var oldObjectIds = _this.existingObjectIds;
                    var objectIds = [];
                    var updateFeatures = [];
                    var addFeatures = [];
                    ...
                    var deleteFeatures = oldObjectIds
                    ...
                    _this.existingObjectIds = objectIds;
